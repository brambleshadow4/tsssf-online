export default {
	...
	"GamePlayerTurn": "It is currently {0}'s turn  zzzz", // {0} is the player's name
	...
	"GameEffectCopying": "Copying {0} zzzz", // {0} is the name of a card
	...
	"PopupTextWonGoals": "{0}'s won goals zzzz", // {0} is the player name
	...
	"HostSettingKickPlayerButton": "Kick {0} zzzz", // {0} is the player's name
