var cards = {
	...
	// CORE DECK
		...
		// Ships
			"Core.Ship.Amnesia": {
				url:"Ship_Amnesia!.png",
				action: "playFromDiscard"
			},
			"Core.Ship.BadPonyGoToMyRoom": {
				url:"Ship_Bad Pony! Go to My Room!.png",
				action: "playFromDiscard"
			},
			"Core.Ship.BeachEpisode": {
				url:"Ship_Beach Episode.png"
			},
			"Core.Ship.BoredOnASundayAfternoon": {
				url:"Ship_Bored on aSunday Afternoon.png"
			},
			"Core.Ship.CabinInTheWoodsAwooo": {
				url:"Ship_Cabin in theWoods Awooo!.png",
				action: "playFromDiscard"
			},
			"Core.Ship.CanITellYouASecret": {
				url:"Ship_Can I Tell You a Secret.png",
				action: "genderChange"
			},
			"Core.Ship.CheckingItOffMyList": {
				url:"Ship_Checking It Off My List.png"
			},
			"Core.Ship.ClosedDoorNegotiations": {
				url:"Ship_Closed Door Negotiations.png"
			},
			"Core.Ship.CrossoverFic": {
				url:"Ship_Crossover Fic!.png",
				action: "playFromDiscard"
			},
			"Core.Ship.CultMeeting": {
				url:"Ship_Cult Meeting.png",
				action: "raceChange"
			},
			"Core.Ship.CutieMarkCrusadersMatchmakers": {
				url:"Ship_Cutie Mark CrusadersMatchmakers!.png"
			},
			"Core.Ship.Detention": {
				url:"Ship_Detention.png"
			},
			"Core.Ship.DivineIntervention": {
				url:"Ship_Divine Intervention.png"
			},
			...
			"Core.Ship.FillyhoodCrush": {
				url:"Ship_Fillyhood Crush.png"
			},
			"Core.Ship.FromAnAlternateDimension": {
				url:"Ship_From an AlternateDimension.png",
				action: "timelineChange"
			},
			"Core.Ship.HaveYouMetMyFriend": {
				url:"Ship_Have You Met My Friend.png"
			},
			"Core.Ship.HowToPickUpMaresAReferenceGuide": {
				url:"Ship_How to Pick Up MaresA Reference Guide.png"
			},
			"Core.Ship.IReadThatInABookOnce": {
				url:"Ship_I Read That in a Book Once!.png"
			},
			"Core.Ship.IWishIKnewHowToQuitYou": {
				url:"Ship_I Wish I KnewHow to Quit You!.png"
			},
			"Core.Ship.ItWasYouAllAlong": {
				url:"Ship_It Was You All Along!.png"
			},
			"Core.Ship.ItsASign": {
				url:"Ship_It's a Sign.png"
			},
			"Core.Ship.LeavingOnAPersonalCrusade": {
				url:"Ship_Leaving on aPersonal Crusade.png"
			},
			"Core.Ship.LifeThreateningIllness": {
				url:"Ship_Life-Threatening Illness.png"
			},
			"Core.Ship.LovePoisonIsNoJoke": {
				url:"Ship_Love Poison Is No Joke!.png",
				action: "lovePoison"
			},
			"Core.Ship.MyLittleShotgunWedding": {
				url:"Ship_My LittleShotgun Wedding.png"
			},
			"Core.Ship.NothingInCommonPerfectAnyway": {
				url:"Ship_Nothing in Common;Perfect Anyway.png"
			},
			"Core.Ship.NowKiss": {
				url:"Ship_Now Kiss!.png"
			},
			"Core.Ship.OnTheLam": {
				url:"Ship_On the Lam.png",
				action: "timelineChange"
			},
			"Core.Ship.OopsWrongSpell": {
				url:"Ship_Oops! Wrong Spell..png",
				action: "genderChange"
			},
			"Core.Ship.PutARingOnIt": {
				url:"Ship_Put a Ring on It.png"
			},
			"Core.Ship.Rule63": {
				url:"Ship_Rule 63.png",
				action: "genderChange"
			},
			"Core.Ship.SawYouInADream": {
				url:"Ship_Saw You in a Dream.png"
			},
			"Core.Ship.ShmoopyBoo": {
				url:"Ship_Shmoopy Boo!.png",
				action: "lovePoison"
			},
			"Core.Ship.SlapSlapKiss": {
				url:"Ship_Slap-Slap Kiss.png"
			},
			"Core.Ship.SoThatsWhatThatDoes": {
				url:"Ship_So THAT'S What That Does!.png",
				action: "raceChange"
			},
			"Core.Ship.StartlingConfession": {
				url:"Ship_Startling Confession.png",
				action: "genderChange"
			},
			"Core.Ship.StepIntoMyBasement": {
				url:"Ship_Step into My Basement.png",
				action: "raceChange"
			},
			"Core.Ship.StuckOnABalconyAllNight": {
				url:"Ship_Stuck on a BalconyAll Night.png"
			},
			"Core.Ship.SuspiciouslyRomanticRandomPicnic": {
				url:"Ship_Suspiciously RomanticRandom Picnic.png"
			},
			"Core.Ship.TheOtherMare": {
				url:"Ship_The Other Mare.png"
			},
			"Core.Ship.ThereAreNoBrakesOnTheLoveTrain": {
				url:"Ship_There Are No Brakeson the Love Train.png"
			},
			"Core.Ship.TheyFightCrime": {
				url:"Ship_They Fight Crime.png"
			},
			"Core.Ship.TheyreAtItAgain": {
				url:"Ship_They're at It Again!.png"
			},
			"Core.Ship.TimeForAnExperiment": {
				url:"Ship_Time For an Experiment!.png",
				action: "raceChange"
			},
			"Core.Ship.TradingUp": {
				url:"Ship_Trading Up.png"
			},
			"Core.Ship.TrappedInAStorm": {
				url:"Ship_Trapped in a Storm.png"
			},
			"Core.Ship.UnexpectedPregnancy": {
				url:"Ship_Unexpected Pregnancy.png"
			},
			"Core.Ship.WantItNeedIt": {
				url:"Ship_Want It. Need It..png",
				action: "lovePoison"
			},
			"Core.Ship.WeveGottoStopMeetingLikeThis": {
				url:"Ship_We've Got toStop Meeting Like This.png"
			},
			"Core.Ship.WhatDidIDoLastNight": {
				url:"Ship_What Did I Do Last Night!.png"
			},
